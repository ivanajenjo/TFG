...
def main():
    ...
    variables_por_mi = ['Adjusted_Function_Points', 'Functional_Size', 'Project_Elapsed_Time', 'Primary_Programming_Language', 'Industry_Sector', 'First_Data_Base_System', 'Development_Platform', 'Used_Methodology', 'Development_Type', 'Language_Type', 'Application_Group']
    variables_por_mrmr = ['Adjusted_Function_Points', 'Development_Platform', 'Functional_Size', 'Project_Elapsed_Time', 'Primary_Programming_Language', 'Industry_Sector', 'First_Data_Base_System', 'Development_Type', 'Used_Methodology', 'Language_Type', 'Application_Group']
    var_c_mi = ['Primary_Programming_Language', 'Industry_Sector', 'First_Data_Base_System', 'Development_Platform', 'Used_Methodology', 'Development_Type', 'Language_Type', 'Application_Group']
    var_n_mi = ['Adjusted_Function_Points', 'Functional_Size', 'Project_Elapsed_Time']
    var_c_mrmr = [ 'Development_Platform', 'Primary_Programming_Language', 'Industry_Sector', 'First_Data_Base_System', 'Development_Type', 'Used_Methodology', 'Language_Type', 'Application_Group']
    var_n_mrmr =['Adjusted_Function_Points', 'Functional_Size', 'Project_Elapsed_Time']
    ...
    for k in range(1, 2):
        ...
        for i in range(iteraciones):
            ...
            mmre = select_features.greedy_forward_selection_r(k, 'Normalised_Work_Effort_Level_1', var, df)
        ...
        for i in range(iteraciones):
            ...
            iteration_start = time.time()
            mmre = select_features.doquire_forward_selection_r(k, 'Normalised_Work_Effort_Level_1', var_n_mi[:], var_c_mi[:], df)
            mmres.append((mmre[3])[-1])
            var_elegidas.append(mmre[1])
            ks.append(k)
            iteration_time = time.time() - iteration_start
        ...
        for i in range(iteraciones):
            ...
            iteration_start = time.time()
            mmre = select_features.doquire_forward_selection_r(k, 'Normalised_Work_Effort_Level_1', var_n_mrmr[:], var_c_mrmr[:], df)
            mmres.append((mmre[3])[-1])
            var_elegidas.append(mmre[1])
            ks.append(k)
            iteration_time = time.time() - iteration_start
